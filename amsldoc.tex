\documentclass[11pt,leqno,titlepage,openany]{amsldoc}[1999/12/13]
...
% ----------------------------------------------------------------------
\usepackage[top=25mm,bottom=20mm]{geometry}
...
\def\ps@headings{\ps@empty
  \def\@oddfoot{\hfil Vn\TeX\ (\url{http://vntex.sarovar.org/})\hfil}
  \def\@evenhead{%
...
\author{%
	\emph{Tác giả:} Hội Toán học Mỹ (AMS)
	\\\medskip
	\emph{Biên dịch: %
		%{\bf ccc} (\url{http://vntex.sarovar.org/authors/ccc/})}
		{\sl ccc@Vn\TeX}} (\url{mailto:kyanh@users.sarovar.org})}
\date{%
	1999/12/13 - 2004/11/03\\
...
tải về: \url{http://vntex.sarovar.org/download/}).
