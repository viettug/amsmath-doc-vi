...
%% $Id$
%%
%% This is the file `amsldoc-vn(-print).tex'
%% 
%% ----------------------------------------------------------
...
\item[\opt{tbtags}]%\index{option!tbtags}
...
\item[\opt{sumlimits}] (mặc định)%\index{option!submlimits}
...
\item[\opt{nosumlimits}]%\index{option!nosumlimits}
...
\item[\opt{intlimits}]%\index{option!intlimits}
...
\item[\opt{nointlimits}] (mặc định)%\index{option!nointlimits}
Ngược với \opt{intlimits}.

\item[\opt{namelimits}] (mặc định)%\index{option!namelimits}
...
\item[\opt{nonamelimits}] Ngược với \opt{namelimits}.%\index{option!nonamelimits}
...
là \fn{subeqn-vn.pdf} và \fn{subeqn-vn.tex}.)
...
Mọi vấn đề về |font| có thể tìm thấy trong (\fn{fntguide.tex})
...
\IfFileExists{amsldoc-vn.ind}{\input amsldoc-vn.ind}{}
